...
self.__precacheManifest = [
  {
    "url": "webpack-runtime-95de34d031d0d8e0141d.js"
  },
  {
  ...
  },
  {
    ...
    "revision": "f4c8d08281c3a717b0737779f7cd67d0"
  },
  {
...
const navigationRoute = new NavigationRoute(async ({ event }) => {
  ...
  if (!resources || !(await caches.match(`/jacdac-docs/app-97d4d13e0267219ecc69.js`))) {
    return await fetch(event.request)
  }
