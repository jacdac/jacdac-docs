...
- Direct `gatsby`/`gatsby-link` imports in `src/**/*.tsx` have been migrated to local compatibility helpers (`src/compat/gatsbyData.ts`, `src/compat/withPrefix.ts`, `src/compat/navigate.ts`).
