...
<video
    aria-label="Hardware button show large and small heart when pressed"
    style={{ width: "100%" }}
    playsInline
    controls
    preload="metadata"
    muted
    loop
    poster={`${import.meta.env.BASE_URL}videos/user-guide-hardwareheartbeat.jpg`}
>
    <source src={`${import.meta.env.BASE_URL}videos/user-guide-hardwareheartbeat.webm`} type="video/webm" />
    <source src={`${import.meta.env.BASE_URL}videos/user-guide-hardwareheartbeat.mp4`} type="video/mp4" />
...
<video
    aria-label="An animation that shows how to create new roles"
    style={{ width: "100%" }}
    playsInline
    controls
    preload="metadata"
    muted
    loop
    poster={`${import.meta.env.BASE_URL}videos/user-guide-multiroles.jpg`}
>
    <source src={`${import.meta.env.BASE_URL}videos/user-guide-multiroles.webm`} type="video/webm" />
    <source src={`${import.meta.env.BASE_URL}videos/user-guide-multiroles.mp4`} type="video/mp4" />
    Sorry, your browser does not support embedded videos.
</video>
