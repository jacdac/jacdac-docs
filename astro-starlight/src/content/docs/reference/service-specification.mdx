...
Random service identifier generation utility is available in the existing Jacdac tools experience.
...
For a complete list of specification units, use the existing service editor and specification tooling in the current Jacdac docs site.
