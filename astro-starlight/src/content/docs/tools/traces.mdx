---
title: Traces
description: Record traces in your logic analyser and replay them to test your services.
---

import TraceListIsland from "../../../components/tools/TraceListIsland.astro"
