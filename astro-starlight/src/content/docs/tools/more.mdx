...
description: Additional Jacdac web tools for data collection, testing, and hardware workflows.
---
...
- [model uploader](/tools/model-uploader/), deploy Machine Learning models (such as TensorFlow Lite)
- [makecode simulator](/tools/makecode-sim/), launch Jacdac simulators and add matching MakeCode blocks
