...
Jacdac was conceived and created by staff at Microsoft Research in Seattle, USA and Cambridge, UK in conjunction with researchers from Lancaster University, UK. 

### Who owns and maintains Jacdac?

Jacdac was originally hosted on Github within the Microsoft org, under [https://github.com/microsoft/jacdac](https://github.com/microsoft/jacdac); code was made available under an MIT license and other assets under CC-BY-4.0. In 2025 this repository was migrated to [https://github.com/jacdac/jacdac](https://github.com/jacdac/jacdac) where the same licensing terms are maintained. 

Additional information relating to creating Jacdac hardware was also originally hosted under the Microsoft org, at [https://github.com/microsoft/jacdac-ddk](https://github.com/microsoft/jacdac-ddk). Again, permissive MIT and CC-BY-4.0 licenses were used, and additionally the OSI-approved CERN-OHL-P-2.0 license was used to ccover hardware assets in the repository. This has now migrated to the Jacdac org on Github at [https://github.com/jacdac/jacdac-ddk](https://github.com/jacdac/jacdac-ddk).

Jacdac is currently maintained by Lancaster University with support from the Microsoft MakeCode team. As an open source project, we welcome community contributions to Jacdac. 

### Who else is involved with Jacdac?

The Jacdac team works with a number of educational technology providers to deliver the Jacdac experience to end users. These include a number of Jacdac hardware providers such as [Kittenbot](https://jacdac.github.io/jacdac-docs/devices/kittenbot/), [Forward Education](https://jacdac.github.io/jacdac-docs/devices/forward-education/), [Calliope](https://jacdac.github.io/jacdac-docs/devices/calliope-ggmbh/) and [Elecfreaks](https://jacdac.github.io/jacdac-docs/devices/elecfreaks/). If you want to have your hardware listed in the Jacdac device catalog or if you're interested in working with us please [get in touch](mailto:jacdac-enquiries@lancaster.ac.uk). 
